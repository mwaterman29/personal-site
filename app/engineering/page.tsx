...
export default function Projects() {
    ...
    <div className="flex flex-col min-h-full items-center justify-center gap-2">
        <div className='flex flex-col items-center justify-center py-4 gap-2 max-w-[1000px]'>
            ...
            <p>The best way to see what I'm working on is to look at the <a href='https://mavenbio.io/changelog' className='text-blue-500 hover:text-blue-700 visited:text-purple-600'>changelog for my work (mavenbio.io)</a>. We post there biweekly, and as I have written practically 100% of the code on the front-end, it's the best place to see what I'm up to on a day-to-day basis.</p>
